...
y = tf.keras.layers.Conv2D(64, (3, 3), activation='relu', padding='same')(encoded)
y = tf.keras.layers.BatchNormalization()(y)
y = tf.keras.layers.Conv2D(64, (3, 3), activation='relu', padding='same')(y)
y = tf.keras.layers.BatchNormalization()(y)
y = tf.keras.layers.UpSampling2D((2, 2))(y)
y = tf.keras.layers.Conv2D(32, (5, 5), activation='relu', padding='same')(y)
y = tf.keras.layers.UpSampling2D((2, 2))(y)
y = tf.keras.layers.Conv2D(16, (3, 3), activation='relu', padding="same")(y)
y = tf.keras.layers.Conv2D(8, (3, 3), activation='relu', padding='valid')(y)
decoded = tf.keras.layers.Conv2D(1, (3, 3), activation='sigmoid', padding='valid')(y)
...
if __name__ == '__main__':
    ...
    tf.keras.models.save_model(autoencoder, 'downscaling_autoencoder_2.h5')
